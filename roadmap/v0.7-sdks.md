# v0.7: Python and Node SDKs

**Theme**: First-class language support for the two largest AI ecosystems.

SDKs ship after MiniLM (v0.6) so Python and Node users get auto-embedding from day one.
...
- v0.6 (auto-embedding) — SDK users get MiniLM from day one
