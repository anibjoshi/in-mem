...
v0.1 shipped BM25 keyword scoring with Reciprocal Rank Fusion. v0.6 added MiniLM auto-embedding. v0.8 connects them: shadow vector collections participate in hybrid search alongside BM25, and new retrieval signals (recency, metadata boosting, graph proximity) make results meaningfully better.
...
- v0.6 (auto-embedding — MiniLM shadow vectors are the primary new signal)
