...
v0.6-v0.10 shipped auto-embedding and natural language search using off-the-shelf models. v0.12 makes the intelligence layer genuinely smart: models fine-tuned for Strata's query patterns, search that remembers conversation history, and proactive data organization.
...
- v0.6 (auto-embedding — fine-tuned MiniLM replaces the off-the-shelf model)
