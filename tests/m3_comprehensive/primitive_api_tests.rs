...
//! - TraceStore: record/record_child/get/query_by_type/get_children/list/count
...
mod tracestore_api {
    ...
    #[test]
    fn test_record_with_tags_and_metadata() {
        let tp = TestPrimitives::new();
        let trace_id = tp
            .trace_store
            .record(
    ...
    fn test_get_nonexistent() {
        let tp = TestPrimitives::new();
        let result = tp.trace_store.get(&tp.run_id, "nonexistent").unwrap();
